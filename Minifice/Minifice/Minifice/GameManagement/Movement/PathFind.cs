...
namespace Minifice.GameManagement.Movement
{
    public class PathFind : MoveStrategy
    {
        ...
        public PathFind(GameMap gameMap, List<Fighter> fighters, List<Enemy> enemies, Unit unit, Unit destination)
        ...
        public override Vector2? Move(GameTime gameTime)
        {
            ...
            if ((unit.position + shift).Similar(destination.position, s + distance)) return null;
